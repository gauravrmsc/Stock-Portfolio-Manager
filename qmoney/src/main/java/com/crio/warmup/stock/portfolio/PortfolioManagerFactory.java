...
public class PortfolioManagerFactory {
  ...
  public static PortfolioManager getPortfolioManager(RestTemplate restTemplate) {
    PortfolioManager portfoloiManager = new PortfolioManagerImpl(restTemplate);
    return portfoloiManager;
  }

  public static PortfolioManager getPortfolioManager(StockQuotesService stockQuotesService) {
    PortfolioManager portfoloiManager = new PortfolioManagerImpl(stockQuotesService);
    return portfoloiManager;
  }
